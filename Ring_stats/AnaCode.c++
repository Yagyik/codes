...
#include"reader/readLammps_NT.h"

//#include"functions/Gr.h"
#include"functions/Gr_Simp_integ.h"
...
//#include"functions/Interface_v2.h"
//#include"functions/ring_finding_3d_v1.h"
//#include"functions/ring_finding_3d_v2_fs.h"
#include"functions/ring_finding_3d_v3_fs.h"
...
/////////////////////////// Initialization ///////////////////////////////////////////
	...
	if(s.Ring==1)
	Init_spring_3d(&s,&d,&spring);
	//if(s.entropy==1)
	//Init_entropy(&s,&d,&entropy);
	//if(s.OrPar_la==1)
...
/////////////////////////// Computation ///////////////////////////////////////////
	...
	for(t=s.StartAt;t<s.StopAt;t+=s.Step)
	{
		...
		readLammps(fp,&s,&d,t);
        printf("fclose giving trouble for some reason??\n");
		fclose(fp);
		printf("have we read coords at %d\n",t);
		if(s.Gr==1)
		...
		//if(s.Interface==1)
		//compute_Interface(&s,&d,&grain);
		if(s.Ring==1)
		compute_spring_3d(&s,&d,&spring);
		//if(s.entropy==1)
		//compute_entropy(&s,&d,&entropy);
		//if(s.OrPar_la==1)
